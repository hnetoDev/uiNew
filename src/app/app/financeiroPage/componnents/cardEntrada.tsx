...
export function CardEntrada(userCurrent:Aluno){
  ...
  return <div className="flex w-full items-center justify-between">
    ...
    <div className="flex space-x-12 items-center">
      ...
      <div className=" max-sm:w-12 w-32   overflow-hidden">
        <h1 className="text-green-400 max-sm:ml-0 ml-14 text-center text-sm font-bold m-auto break-words">PIX</h1>
      </div> 

      <div className="w-48  break-words ">
        <h1 className=" text-yellow-400 text-sm max-sm:invisible font-bold text-center break-words">22/05/24</h1>
      </div>
