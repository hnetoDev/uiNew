...
export function Caixa({caixaA}:{caixaA:CaixaType[]}){

  const month = new Date().getMonth()
  const caixaFill = caixaA.filter(c => c.name === month)
  const caixa = caixaFill[0];
  console.log(caixa)
  ...
  if(caixa !== undefined){
    ...
    <div className="bg-bg border max-sm:w-full border-green-400 rounded-lg p-4 items-center justify-center">
      ...
      <h1 className="font-bold text-center text-green-400">R${String(total)},00</h1>
    </div>
    ...
    <div className="flex max-sm:w-full items-center max-sm:flex-col max-sm:space-y-3 max-sm:space-x-0 space-x-4">
      ...
      <div className="bg-bg border max-sm:w-full border-yellow-400 rounded-lg p-4 items-center justify-center">
        ...
        <h1 className="font-bold text-center text-green-400">R${caixa.aplicativo !== null ? String(caixa.aplicativo) : '00' },00</h1>
      </div>

      <div className="bg-bg border max-sm:w-full border-yellow-400 rounded-lg p-4 items-center justify-center">
        <h1 className="text-xl text-white font-bold text-center">Pix:</h1>
        <h1 className="font-bold text-center text-green-400">R${caixa.pix ? String(caixa.pix) : '00' },00</h1>
      </div>

      <div className="bg-bg border max-sm:w-full border-yellow-400 rounded-lg p-4 items-center justify-center">
        <h1 className="text-xl text-white font-bold text-center">Dinheiro</h1>
        <h1 className="font-bold text-center text-green-400">R${caixa.dinheiro ? String(caixa.dinheiro) : '00'},00</h1>
      </div>
