...
export function Form(){
  ...
  return(
    <>
      <div className="w-full h-screen overflow-scroll sc  bg-bg flex max-md:flex-col  ">
        <div className='my-auto max-md:m-auto css pl-12  w-1/2 max-sm:w-4/5 max-md:w-5/6 space-y-3 p-0'>
          <h1 className='text-6xl max-md:text-5xl max-sm:text-5xl   text-yellow-400'>Insira os dados</h1>
          <h1 className='text-white text-6xl max-md:text-5xl max-sm:text-5xl'>p/Administrar TEA</h1>
